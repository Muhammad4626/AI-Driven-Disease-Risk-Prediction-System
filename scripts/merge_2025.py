...
disease_df = pd.read_excel('disease_data_2025.xlsx')
weather_df = pd.read_excel('weather_data_2025.xlsx')
...
final_df.to_csv('flood_disease_dataset_2025.csv', index=False)
